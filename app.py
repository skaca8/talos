...
- urgency: 누수·파손·깨짐(유리·창문·거울 등 다칠 위험)·안전·위생·전기/화재 위험이 하나라도 있으면 urgent. 단순 비품 부족이나 경미한 점검만이면 normal.
- short: 대시보드 칸용 15자 이내(예: "타일 균열·누수"). 여러 문제면 대표/최신 기준. has_issue=false면 "".
- ai_read: 사진이 있을 때만 하자 1문장과 위험도. 사진 없으면 "".
JSON 외 텍스트 금지."""
